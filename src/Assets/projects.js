const projects = [
  {
    ...
    description: "A professional networking app to connect technical and non-technical founders"
  },
  {
    name: "uNight",
    // src:
    ...
    description:
      "A nightlife coordination app that allows users to search for bars within an area and allows signed-in users to RSVP to particular bars"
  },
  {
    name: "crypTick",
    src:
    ...
    description:
      "A real-time price quoting toolbar for cryptocurrencies utilizing data from GDAX exchange API and emitting updates to connected clients via websockets "
  },
  {
    name: "Chart It",
    src:
    ...
    description:
      "A full-stack stock charting app that emits a centralized watchlist in real-time to all clients"
  },
  {
    name: "VoterZ",
    src:
    ...
    description:
      "A full-stack voting app that allows non-authenticated users to vote on different polls and allows authenticated users to manage polls they create "
  },
  {
    name: "Momentum Clone",
    src:
    ...
    description: "A clone of the popular browser extension"
  },
  {
    name: "Calculator",
    src:
  ...
  },
  {
    ...
    description: "A clone of the Simon Game"
  }
];
